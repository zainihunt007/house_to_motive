              ...
              stream: FirebaseFirestore.instance
                  ...
                  .where('timestamp',
                      isGreaterThanOrEqualTo: DateTime.now().toUtc().subtract(
                          Duration(
                              days: 1))) // Filter videos from the last 24 hours
                  .snapshots(),
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  // Show shimmer effect while waiting for data
                ...
                if (documents.isEmpty) {
                  ...
                  return Center(
                    child: Text(
                      'No latest videos in the last 24 hours',
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    Map<String, dynamic>? data = doc.data()
                        as Map<String, dynamic>?; // Retrieve document data

                    // Check if data is null or empty
                    if (data == null || data.isEmpty) {
                      return Container(); // or handle the case appropriately
                    }
